...
VALUES 
(10, 9, 1, (SELECT preco FROM produto WHERE id_produto = 9)),
(10, 11, 3, (SELECT preco FROM produto WHERE id_produto = 11)),
(10, 15, 2, (SELECT preco FROM produto WHERE id_produto = 15));
